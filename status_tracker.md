...
| 4 | `major_exchange_listed_timeseries` | Time Series | **`YES`** | Fully implemented, cached locally via Parquet, supporting recarray, dataframe and ndarray formats. |
| 5 | `capital_event_timeseries` | Time Series | **`YES`** | Fully implemented, cached locally via Parquet, supporting recarray, dataframe and ndarray formats. |
| 6 | `dividend_yield_timeseries` | Time Series | **`YES`** | Fully implemented, cached locally via Parquet, passes yield test. |
| 7 | `padding_status_timeseries` | Time Series | **`PLAN`** | Individual implementation plan created at [plans/padding_status_implementation_plan.md](file:///c:/Projects/claudeai/gemini/ngd_proxy/plans/padding_status_implementation_plan.md). |
